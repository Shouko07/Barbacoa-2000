  ...
  describe "POST /create" do
    context "with valid parameters" do
      it "creates a new Evento" do
        expect {
          post eventos_url, params: { evento: valid_attributes }
        }.to change(Evento, :count).by(1)
      end

      it "redirects to the created evento" do
        post eventos_url, params: { evento: valid_attributes }
        expect(response).to redirect_to(evento_url(Evento.last))
      end
    end
    ...
    context "with invalid parameters" do
      it "does not create a new Evento" do
        expect {
          post eventos_url, params: { evento: invalid_attributes }
        }.to change(Evento, :count).by(0)
      end
  ...
  describe "PATCH /update" do
    context "with valid parameters" do
      ...
      it "updates the requested evento" do
        evento = Evento.create! valid_attributes
        patch evento_url(evento), params: { evento: new_attributes }
        evento.reload
      ...
      it "redirects to the evento" do
        ...
        patch evento_url(evento), params: { evento: new_attributes }
        evento.reload
        expect(response).to redirect_to(evento_url(evento))
      end
    end
    ...
    context "with invalid parameters" do
      it "renders a response with 422 status (i.e. to display the 'edit' template)" do
        evento = Evento.create! valid_attributes
        patch evento_url(evento), params: { evento: invalid_attributes }
        expect(response).to have_http_status(:unprocessable_entity)
      end
    end
  end
